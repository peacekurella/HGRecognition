...
#trying to remove background, uncomment to use
#fgbg = cv2.createBackgroundSubtractorMOG2()

#Changes need to be made wrt the threshold value. Use dynamic values.
...
while 1:
	...
	#make change here. 
	retval2,thresh1 = cv2.threshold(gray,175,255,cv2.THRESH_OTSU+cv2.THRESH_BINARY) # THRESHOLDING IMAGE
	...
	if len(contours) > 0:
		...
		if count_defects == 1:
			...
			cv2.putText(img,"THIS IS 5", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 3, 3)
